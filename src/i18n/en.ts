...
export const en: Record<string, string> = {
  ...
  'autoCreate.sourceMode.colorBlockSummary': 'Using current-camp color blocks: {count}',
  ...
  'autoCreate.section.colorBlockFilter': 'Color block filter',
  'autoCreate.colorBlockFilter.sourceSummary': 'Using blocks: {enabled} / {total}',
  'autoCreate.colorBlockFilter.visibleSummary': 'Visible: {count}',
  'autoCreate.colorBlockFilter.searchPlaceholder': 'Search block name / id / deco code',
  'autoCreate.colorBlockFilter.listLabel': 'AutoCreate color blocks',
  'autoCreate.colorBlockFilter.noMatch': 'No matching color blocks.',
  'autoCreate.colorBlockFilter.emptyWarning': 'All color blocks are excluded. Keep at least one color block.',
