...
export const en: Record<string, string> = {
  ...
  'status.pinOutlineInserted': 'Inserted {count} pin outline deco layers',
  ...
  'edit.enableHeadGlowAlwaysOn': 'Turn on always-on head green outline',
  'edit.disableHeadGlowAlwaysOn': 'Turn off always-on head green outline',
  ...
  'extra.entry.pinOutline': 'Pin outline',
  ...
  'extra.algorithm.hsv': 'HSV hue matching',
  'extra.algorithm.hsl': 'HSL color matching',
  'extra.algorithm.brightness-color': 'Brightness + color',
  ...
  'extra.pinOutline.start': 'Enable pin outline',
  'extra.pinOutline.stop': 'Disable pin outline',
  'extra.pinOutline.clear': 'Clear pins and outline',
  'extra.pinOutline.help': 'Enable the tool and click the stage to place pins. Three or more pins create a closed outline.',
  'extra.pinOutline.activeHelp': 'Click the stage to place pins, or drag a pin to move it.',
  'extra.pinOutline.pinCount': 'Pins: {count}',
  'extra.pinOutline.needMore': 'At least 3 pins are required',
  'extra.pinOutline.ready': 'Closed region ready',
  'extra.pinOutline.removePin': 'Remove pin {index}',
  'extra.pinOutline.moveUp': 'Move up',
  'extra.pinOutline.moveDown': 'Move down',
  'extra.pinOutline.segments': 'Boundary paths',
  'extra.pinOutline.line': 'Line',
  'extra.pinOutline.quadratic': 'Quadratic curve',
  'extra.pinOutline.formula': 'Formula',
  'extra.pinOutline.curvature': 'Curvature',
  'extra.pinOutline.material': 'Outline materials',
  'extra.pinOutline.chooseMaterial': 'Choose a deco material',
  'extra.pinOutline.singleMaterial': 'This role has no camp, so only one material can be used.',
  'extra.pinOutline.selectedMaterial': 'Selected material: {name}',
  'extra.pinOutline.removeMaterial': 'Remove material',
  'extra.pinOutline.insert': 'Insert into role layers',
  'extra.pinOutline.groupName': 'Pin outline',
  'extra.pinOutline.rotation': 'Rotation',
  'extra.pinOutline.scale': 'Scale',
  'extra.pinOutline.ratio': 'Ratio',
  ...
  'autoCreate.section.sourceFilter': 'Source title filter',
  'autoCreate.filter.sourceSummary': 'Assets enabled: {enabled} / {total}',
  'autoCreate.filter.titleSummary': 'Titles enabled: {enabled} / {total}',
  'autoCreate.filter.searchPlaceholder': 'Search title or decoration name',
  'autoCreate.filter.useAll': 'Use all',
  'autoCreate.filter.useVisible': 'Use visible',
  'autoCreate.filter.excludeVisible': 'Exclude visible',
  'autoCreate.filter.listLabel': 'Source titles available to AutoCreate',
  'autoCreate.filter.noMatch': 'No matching titles.',
  'autoCreate.filter.emptyWarning': 'All assets are excluded. Keep at least one title enabled.',
  'autoCreate.error.workerUnavailable': 'This browser does not support AutoCreate background processing. To prevent the page from freezing, the main-thread fallback is disabled. Use desktop Chrome, Edge, or Firefox.',
  'autoCreate.error.emptyTarget': 'The target image has no visible pixels. Choose an image with non-transparent content.',
  'autoCreate.error.noPlacementArea': 'The visible area is too thin to safely contain a decoration. Choose an image with a larger opaque interior.',
  'autoCreate.warning.previewRenderFailed': 'Workspace preview rendering failed: {message}. No output preview is shown because it could differ after insertion.',
