...
export const en: Record<string, string> = {
  ...
  'autoCreate.section.learning': 'Candidate ranking',
  'autoCreate.learning.enabled': 'Enable MLP learning and approved candidate ranking (legacy remains active until the Full gate passes)',
  'autoCreate.learning.rankerLab': 'Locally test the trained ranker',
  'autoCreate.learning.rankerLabWarning': 'Local experiment is bypassing the rollout gate; model: {revision}; modes: {modes}. This is not a production approval.',
  'autoCreate.learning.exportPortable': 'Export local training data',
  'autoCreate.learning.importPortable': 'Import local model',
  'autoCreate.learning.cancelExport': 'Cancel export',
  'autoCreate.learning.portableUnsupported': 'This browser cannot write directly to a selected folder. Use local Chrome/Chromium.',
  'autoCreate.learning.exportProgress': 'Scanned {scanned}; exported {exported}; {shards} shards.',
  'autoCreate.learning.exportDone': 'Training export complete: {count} rows in {shards} shards.',
  'autoCreate.learning.importDone': 'Local model imported: {revision}',
  'autoCreate.learning.summary': 'Status: {phase} · Add: {add} · Replace: {replace} · Model: {revision}',
  'autoCreate.learning.fallback': 'Ranker fell back to legacy search: {reason}',
  'autoCreate.learning.clear': 'Clear learning data for this camp',
  'autoCreate.learning.working': 'Working…',
  'autoCreate.learning.clearWarning': 'Learning records were cleared, but some TensorFlow.js model files could not be removed: {message}',
