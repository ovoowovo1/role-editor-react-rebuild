...
export const zhTW: Record<string, string> = {
  ...
  'autoCreate.sourceMode.colorBlockSummary': '選取色塊：{label}',
  'autoCreate.colorBlock.loading': '正在載入目前陣營色塊...',
  'autoCreate.colorBlock.empty': '目前陣營沒有可用色塊。',
  'autoCreate.section.colorBlockFilter': '色塊選擇',
  'autoCreate.colorBlockFilter.sourceSummary': '已選色塊：{label}',
  'autoCreate.colorBlockFilter.visibleSummary': '目前顯示：{count}',
  'autoCreate.colorBlockFilter.totalSummary': '全部：{count}',
  'autoCreate.colorBlockFilter.searchPlaceholder': '搜尋色塊名稱 / id / color / deco code',
  'autoCreate.colorBlockFilter.listLabel': 'AutoCreate 單一色塊選擇',
  'autoCreate.colorBlockFilter.noMatch': '找不到符合的色塊。',
  'autoCreate.colorBlockFilter.emptyWarning': '請選擇一個色塊。',
