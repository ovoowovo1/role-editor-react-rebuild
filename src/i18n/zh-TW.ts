...
export const zhTW: Record<string, string> = {
  ...
  'autoCreate.section.colorBlockFilter': '色塊過濾',
  'autoCreate.colorBlockFilter.sourceSummary': '使用色塊：{enabled} / {total}',
  'autoCreate.colorBlockFilter.visibleSummary': '目前顯示：{count}',
  'autoCreate.colorBlockFilter.searchPlaceholder': '搜尋色塊名稱 / id / deco code',
  'autoCreate.colorBlockFilter.listLabel': 'AutoCreate 可使用的色塊',
  'autoCreate.colorBlockFilter.noMatch': '找不到符合的色塊。',
  'autoCreate.colorBlockFilter.emptyWarning': '所有色塊都被排除了，請至少保留一個色塊。',
