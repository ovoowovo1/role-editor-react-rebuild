...
export const zhTW: Record<string, string> = {
  ...
  'status.pinOutlineInserted': '已加入 {count} 個圖釘描邊裝飾圖層',
  ...
  'extra.pinOutline.start': '啟用圖釘描邊',
  'extra.pinOutline.stop': '停用圖釘描邊',
  'extra.pinOutline.clear': '清除圖釘與描邊',
  'extra.pinOutline.help': '啟用後點擊舞台放置圖釘，至少三個圖釘會形成封閉描邊。',
  'extra.pinOutline.activeHelp': '請在舞台點擊放置圖釘，也可以拖曳圖釘調整位置。',
  'extra.pinOutline.pinCount': '圖釘：{count}',
  'extra.pinOutline.needMore': '至少需要 3 個圖釘',
  'extra.pinOutline.ready': '已建立封閉區域',
  'extra.pinOutline.removePin': '刪除第 {index} 個圖釘',
  'extra.pinOutline.moveUp': '上移',
  'extra.pinOutline.moveDown': '下移',
  'extra.pinOutline.segments': '邊界路徑',
  'extra.pinOutline.line': '直線',
  'extra.pinOutline.quadratic': '二次曲線',
  'extra.pinOutline.formula': '公式',
  'extra.pinOutline.curvature': '曲率',
  'extra.pinOutline.material': '描邊素材',
  'extra.pinOutline.chooseMaterial': '選擇 deco 素材',
  'extra.pinOutline.singleMaterial': '目前角色沒有陣營，只能使用一個素材。',
  'extra.pinOutline.selectedMaterial': '目前素材：{name}',
  'extra.pinOutline.removeMaterial': '移除素材',
  'extra.pinOutline.insert': '加入角色圖層',
  'extra.pinOutline.groupName': '圖釘描邊',
  'extra.pinOutline.rotation': '旋轉',
  'extra.pinOutline.scale': '縮放',
  'extra.pinOutline.ratio': '比例',
  ...
  'autoCreate.section.settings': '生成設定',
  'autoCreate.iterations': '迭代次數 / --tiles',
  'autoCreate.budget': '圖塊預算 / --tile-budget',
  'autoCreate.logEvery': '進度更新間隔 / --log-every',
  'autoCreate.savePreview': '生成過程儲存預覽',
  'autoCreate.section.sourceFilter': '素材標題篩選',
  'autoCreate.filter.sourceSummary': '啟用素材：{enabled} / {total}',
  'autoCreate.filter.titleSummary': '啟用標題：{enabled} / {total}',
  'autoCreate.filter.searchPlaceholder': '搜尋標題或裝飾名稱',
  'autoCreate.filter.useAll': '全部啟用',
  'autoCreate.filter.useVisible': '啟用目前顯示',
  'autoCreate.filter.excludeVisible': '排除目前顯示',
  'autoCreate.filter.listLabel': 'AutoCreate 可使用的素材標題',
  'autoCreate.filter.noMatch': '找不到符合的標題。',
  'autoCreate.filter.emptyWarning': '所有素材都已排除，請至少保留一個標題。',
  'autoCreate.error.workerUnavailable': '目前瀏覽器不支援 AutoCreate 背景運算。為避免頁面無回應，已停用主執行緒備援；請使用桌面版 Chrome、Edge 或 Firefox。',
  'autoCreate.error.emptyTarget': '目標圖片沒有可見像素，請選擇含有非透明內容的圖片。',
  'autoCreate.error.noPlacementArea': '目標的可見區域太窄，無法安全容納裝飾；請選擇具有較大不透明內部區域的圖片。',
  'autoCreate.warning.previewRenderFailed': '無法使用工作區渲染器產生預覽：{message}。為避免與插入結果不一致，不顯示 Worker 預覽。',
