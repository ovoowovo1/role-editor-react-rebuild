            ...
            )),
            {
                ...
                execute: function() {
                    ...
                    N = class extends React.Component {
                        ...
                        updateActorPosition() {
                            const bg = this.stageBgRef.current;
                            const canvas = s.renderer && s.renderer.view;
                            ...
                            const point = new PIXI.Point(
                                bgRect.left + bgRect.width / 2 - canvasRect.left,
                                bgRect.top + bgRect.height / 2 - canvasRect.top
                            );

                            const local = s.root.toLocal(point);
                            this.actorStage.position.set(local.x, local.y);
                        }
                        onBtnTab(e) {
